            ...
            <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 bg-white p-1 rounded-md z-10 hidden" id="modal">
                <div className="w-full h-full border-orange-300 border-2 rounded-md">
                    <div className="bg-orange-300 px-6 py-2">
                        <h2 className="text-2xl inline-block w-11/12">Add Metric</h2>
                        <span className="inline-block w-1/12 text-right cursor-pointer font-bold" onClick={hideModal}>X</span>
                    </div>
                    <div className="p-6">
                        ...
                        <Button label="Save" onClick={handleAddMetric} variant="primary" disabled={false} />
                    </div>
                </div>
            </div>
        </>
