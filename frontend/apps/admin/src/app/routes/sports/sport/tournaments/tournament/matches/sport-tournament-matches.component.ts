...
@Component({
  selector: 'app-sport-tournament-matches',
  imports: [CommonModule, RouterLink],
  templateUrl: './sport-tournament-matches.component.html',
})
export class SportTournamentMatchesComponent implements OnInit {
    sportId!: string;
    sport!: Sport;
